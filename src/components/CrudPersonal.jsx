                    ...
                    updateId.length > 0 && showUpdateForm && (
                        <Form className='mb-5'>
                            <Form.Group className="font-monospace" controlId="formChangeNameP">
                                ...
                                {
                                Errores.updateName &&(
                                    <span className="Errores text-white">{Errores.updateName}</span>
                                )
                            }
                            </Form.Group>
                            <Form.Group className="font-monospace" controlId="formChangeLastNameP">
                                ...
                                Errores.updateLastname &&(
                                    <span className="Errores text-white">{Errores.updateLastname}</span>
                                )
                            }
                            </Form.Group>
                            <Form.Group className="font-monospace" controlId="formChangeCellphoneP">
                                ...
                                Errores.updateTelefono &&(
                                    <span className="Errores text-white">{Errores.updateTelefono}</span>
                                )
                            }
                            </Form.Group>
                            <Form.Group className="font-monospace " controlId="formChangeEmailP">
                                ...
                                Errores.updateCorreo &&(
                                    <span className="Errores text-white">{Errores.updateCorreo}</span>
                                )
                            }
                            </Form.Group>
                            <Form.Group className="font-monospace" controlId="formChangeDniP">
                                ...
                                />
                                 {
                                Errores.updateDni &&(
                                    <span className="Errores text-white">{Errores.setUpdateDni}</span>
                                )
                            }
                            </Form.Group>
                            <Row>
