      ...
      <>
        <Container className="container-fluid">
          <Row>
            ...
            />
            <Form
              className={`mb-1 ${Styles["personal__create-form"]}`}
              style={{ height: showCreateForm ? "auto" : undefined }}
            >
              <Form.Group
                className={`font-monospace`}
                controlId="formBasicNameP"
              >
                ...
                {Errores.namePersonal && (
                  <span className="Errores text-white">
                    {Errores.namePersonal}
                  </span>
                )}
              </Form.Group>
          ...
          >
            ...
            <Modal.Body>
              <Form className="mb-5">
                ...
                <Form.Group
                  className="font-monospace"
                  controlId="formChangeCellphoneP"
                >
                  <Form.Label>Telefono</Form.Label>
                  <Form.Control
                    type="tel"
          ...
          <Row>
            <Col
              className={`d-flex justify-content-center ${Styles["custom-container-Perso"]}`}
            >
              <h2
                className={`font-monospace text-decoration-none ${Styles["fs-h2"]}`}
              >
                Personal Institucion
              </h2>
            </Col>
            <Table
              className={Styles["custom-table-Perso"]}
              striped
              bordered
              hover
            >
                          ...
                          {empleado.isAdmin ? (
                            <>
                              <ButtonIconCustom
                                ...
                                onClick={() =>
                                  handleOpenPasswordModal(empleado._id)
                                }
                              />
                              <ButtonIconCustom
                    ...
                    <Dropdown className={Styles["dropdown-custom"]}>
                      ...
                      <Dropdown.Menu className={Styles["menu-drop-custom"]}>
                        {index === 0 ? (
                          ...
                          <>
                            <Dropdown.Item
                              className={Styles["item-drop-custom"]}
                              href="#/action-1"
                            >
                              <ButtonIconCustom
                                variant="outline-danger"
        ...
        <Modal
          show={showConfirmRevokeModal}
          onHide={() => setShowConfirmRevokeModal(false)}
        >
          <Modal.Header closeButton>
            <Modal.Title className="font-monospace">
              Confirmar revocación de rol
            </Modal.Title>
          </Modal.Header>
          <Modal.Body className="font-monospace">
          ...
          <Modal.Footer>
            <ButtonCustomRedGreen
              color="green"
              onClick={() => setShowConfirmRevokeModal(false)}
              nameBtt="Cancelar"
            />
            <ButtonCustomRedGreen
              color="red"
